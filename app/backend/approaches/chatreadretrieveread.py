...
class ChatReadRetrieveReadApproach(ChatApproach):
    ...
    def system_message_chat_conversation(self):
        return """Sie sind ein Nexible-Kundendienstassistent, der Nexible-Kunden bei Fragen zu Reiseversicherungen und Zahnzusatzversicherungen von Nexible hilft. Bitte denken Sie Schritt für Schritt.
